...
`;function ar(){return n.createElement(nr,null,"Solicite uma apresentação")}const or=Vt.div`
    border-bottom-left-radius: 2rem;
    border-bottom-right-radius: 2rem;   
    height: 50rem;
    display: flex;
...
`;function cr(){return n.createElement(or,null,n.createElement(ir,null,n.createElement(sr,null,"A M2A tem as soluções"),n.createElement(lr,null,"que você precisa para realizar suas contratações governamentais!"),n.createElement(ar,null)))}var ur=r(4794),mr=r(6512);const dr=Wt`
    from {
        width: 0%;
    }
    to {
...
`;function yr(){return n.createElement(fr,null,n.createElement(vr,null,n.createElement(pr,{to:"/inicio",activeClassName:"active"},"Início")),n.createElement(vr,null,n.createElement(pr,{to:"/contratacoes",activeClassName:"active"},"Contratações")),n.createElement(vr,null,n.createElement(pr,{style:{width:"6rem"}},"Produtos ",n.createElement(br,null)),n.createElement(gr,null,n.createElement(hr,{to:"/produto-a",activeClassName:"active"},"M2A Planejamentos"),n.createElement(hr,{to:"/produto-b",activeClassName:"active"},"M2A Compras"),n.createElement(hr,{to:"/produto-c",activeClassName:"active"},"M2A Pesquisas"),n.createElement(hr,{to:"/produto-c",activeClassName:"active"},"M2A Processos"),n.createElement(hr,{to:"/produto-c",activeClassName:"active"},"M2A Processos Eletrônicos"),n.createElement(hr,{to:"/produto-c",activeClassName:"active"},"M2A Tramitações"),n.createElement(hr,{to:"/produto-c",activeClassName:"active"},"M2A Contratos"),n.createElement(hr,{to:"/produto-c",activeClassName:"active"},"M2A Fornecedores"))),n.createElement(vr,null,n.createElement(pr,{to:"/sobre",activeClassName:"active"},"Sobre")),n.createElement(vr,null,n.createElement(pr,{to:"/conteudo",activeClassName:"active"},"Conteúdo")))}const xr=Vt.div`
    width: 100%;
    height: 60rem;
    display: flex;
    align-items: center;
...
`;function wr(e){let{children:t}=e;return n.createElement(xr,null,t)}var Ar=r(5399),Er=r.p+"static/logo-pm-ipixuna-1-6b9d67a817bb074e41745730c212a6b2.png",kr=r.p+"static/logo-pm-itapipoca-cd4757a75cd467f1fbf6f69e79fc9e8a.png";const Cr=Vt.button`
    height: 2.5rem;
    width: 12rem;
    font-weight: 600;
    font-size: 1.1rem;
...
`;function Sr(){return n.createElement(Cr,null,"Mais clientes")}const jr=Vt.div`
    display: flex;
    align-items: center;
    justify-content: center;
    flex-direction: column;
...
`,Nr=[{id:1,src:Er,alt:"Ipixuna"},{id:2,src:kr,alt:"Itapipoca"},{id:3,src:Er,alt:"Ipixuna"},{id:4,src:kr,alt:"Itapipoca"},{id:5,src:Er,alt:"Ipixuna"},{id:6,src:kr,alt:"Itapipoca"},{id:7,src:Er,alt:"Ipixuna"},{id:8,src:kr,alt:"Itapipoca"},{id:9,src:Er,alt:"Ipixuna"},{id:10,src:kr,alt:"Itapipoca"}];function Yr(){const{0:e,1:t}=(0,n.useState)(0),r=(0,n.useRef)(null);return(0,n.useEffect)((()=>{r.current&&(r.current.style.transform=`translateX(${e}px)`)}),[e]),n.createElement(jr,null,n.createElement(zr,null,"Conheça alguns clientes que confiam na M2A e usam nossos produtos"),n.createElement(Ir,null,n.createElement(Or,null,n.createElement(Pr,{onClick:()=>{if(r.current){const e=r.current.querySelector(":scope > div:first-child");if(e){const r=e.offsetWidth+parseFloat(getComputedStyle(e).marginRight);t((e=>Math.min(e+r,0)))}}}},n.createElement(Ar.xrT,{size:20,color:"#004C99"}))),n.createElement(Rr,{ref:r},Nr.map((e=>n.createElement(Dr,{key:e.id},n.createElement(Fr,{src:e.src,alt:e.alt}))))),n.createElement(Or,null,n.createElement(Mr,{onClick:()=>{if(r.current){const e=r.current.querySelector(":scope > div:last-child"),n=r.current.offsetWidth;if(e){const a=e.offsetWidth+parseFloat(getComputedStyle(e).marginRight),o=-(r.current.scrollWidth-n);t((e=>Math.max(e-a,o)))}}}},n.createElement(Ar.Xor,{size:20,color:"#004C99"})))),n.createElement(Sr,null))}const qr=Vt.div`
    position: relative;
    height: 100%;
    width: 100%;
    display: flex;
...
`,En=Vt.label`
    font-family: 'Montserrat Alternates', sans-serif;
    font-size: 1.2rem;
`;function kn(){return n.createElement(vn,null,n.createElement(yn,null,n.createElement(xn,null,n.createElement(An,null,"Nossas soluções são completas para que a gestão governamental do seu munícipio seja realizada com excelência."),n.createElement(En,null,"Nosso portfólio completo permite centralizar todas as soluções de gestão governamental em um único local. Desde o planejamento, passando pela documento de formalização de demanda, processos administrativos e contratação, até a gestão de contratos.")),n.createElement(wn,null,n.createElement(un,{titulo:"M2A Planejamentos",descricao:"Planeje suas demandas",url_imagem:hn}),n.createElement(un,{titulo:"M2A Compras",descricao:"Crie suas demandas",url_imagem:fn}),n.createElement(un,{titulo:"M2A Pesquisas",descricao:"Realize suas cotações de preço",url_imagem:pn}),n.createElement(un,{titulo:"M2A Processos",descricao:"Parametrize suas contratações",url_imagem:gn}),n.createElement(un,{titulo:"M2A Fornecedores",descricao:"Participe de contratações",url_imagem:bn}),n.createElement(un,{titulo:"M2A Contratos",descricao:"Gerencie seus contratos",url_imagem:hn}))),n.createElement(dn,null))}var Cn=r(6973),Sn=r(7909),jn=r(5867),zn=r(5066),In=r(1351),On=r(2388),Pn=r(1406);const Mn=Vt.div`
...
`;function Ln(e){let{titulo:t,descricao:r}=e;return n.createElement(Mn,null,n.createElement(Rn,null,t),n.createElement(Dn,null,r))}function Bn(e){let{icone:t,titulo:r,descricao:a}=e;return n.createElement(Fn,null,n.createElement(Nn,null,t),n.createElement(Yn,null,r),n.createElement(qn,null,a))}function Tn(e){let{valorFinal:t,visible:r,duracao:a=1e3}=e;const{0:o,1:i}=(0,n.useState)(0),s=(0,n.useRef)(0);return(0,n.useEffect)((()=>{const e=performance.now(),r=()=>{const n=performance.now()-e,o=Math.min(n/a,1);i(Math.ceil(o*t)),o<1&&(s.current=requestAnimationFrame(r))};return s.current=requestAnimationFrame(r),()=>cancelAnimationFrame(s.current)}),[t,a,r]),n.createElement("span",null,o)}const Xn=Vt.div`
    min-height: 40rem;
    display: flex;
    align-items: center;
    justify-content: center;
...
`;function Un(){const e=(0,n.useRef)(null),{0:t,1:r}=(0,n.useState)(!1);return(0,n.useEffect)((()=>{const t=new IntersectionObserver((e=>{e.forEach((e=>{e.isIntersecting?r(!0):r(!1)}))}),{threshold:.1});return e.current&&t.observe(e.current),()=>{e.current&&t.unobserve(e.current)}}),[]),n.createElement(Xn,{ref:e},n.createElement(Gn,null,n.createElement(Ln,{titulo:n.createElement(n.Fragment,null,n.createElement("label",null,"+ "),n.createElement(Tn,{visible:t,valorFinal:300,duracao:2500})),descricao:"Clientes"}),n.createElement(Ln,{titulo:n.createElement(n.Fragment,null,n.createElement("label",null,"+ "),n.createElement(Tn,{visible:t,valorFinal:1e4,duracao:2500}),n.createElement("label",null," mil ")),descricao:"Contratações"}),n.createElement(Ln,{titulo:n.createElement(n.Fragment,null,n.createElement("label",null,"+ "),n.createElement(Tn,{visible:t,valorFinal:5e3,duracao:2500}),n.createElement("label",null," mil ")),descricao:"Fornecedores"}),n.createElement(Ln,{titulo:n.createElement(n.Fragment,null,n.createElement("label",null,"+ "),n.createElement(Tn,{visible:t,valorFinal:15e3,duracao:2500}),n.createElement("label",null," mil ")),descricao:"Contratos"})),n.createElement(Bn,{icone:n.createElement(Sn.c4U,null),titulo:"+ 300 mil",descricao:"dfd's criados"}),n.createElement(Bn,{icone:n.createElement(zn.QDl,null),titulo:"+ 250 mil",descricao:"pesquisas realizadas"}),n.createElement(Bn,{icone:n.createElement(jn.xAX,null),titulo:"+ 200 mil",descricao:"pedidos de cotação respondidos"}),n.createElement(Bn,{icone:n.createElement(Cn.fIi,null),titulo:"+ 1 milhão",descricao:"preços importados"}),n.createElement(Bn,{icone:n.createElement(mr.Gjp,null),titulo:"+ 200 mil",descricao:"licitações públicadas"}),n.createElement(Bn,{icone:n.createElement(In.Ua$,null),titulo:"+ 50 mil",descricao:"contratações diretas públicadas"}),n.createElement(Bn,{icone:n.createElement(On.sn$,null),titulo:"+ 20 mil",descricao:"procedimentos auxiliares públicados"}),n.createElement(Bn,{icone:n.createElement(Pn.sGK,null),titulo:"+ 100 mil",descricao:"processos eletrônicos gerenciados"}))}var Vn=r(1735);const Wn=Vt.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`;function oa(e){let{imagem:t,titulo:r,descricao:a,style:o}=e;return n.createElement(_n,{style:o},n.createElement(ea,null,n.createElement(ta,{src:t}),n.createElement(ra,null,n.createElement(na,null,r),n.createElement(aa,null,a))))}var ia=r.p+"static/ia-software-f8494f538ed934a3d0831fe9196cc8fc.png",sa=r.p+"static/ia-2-software-4a24c1234c12e6283803f7de7b5dcbca.png",la=r.p+"static/ia-3-software-5d8d2dd0824c3f5f50e594a2e951b666.png";const ca=Vt.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`,ma=Vt.label`
    ...
    font-family: "Poppins", sans-serif;
    margin: 10rem;
`;function da(){return n.createElement(ca,null,n.createElement(ma,null,"MIA: A Inteligência Artificial que Entende o seu Governo"),n.createElement(ua,null,n.createElement(oa,{style:{alignSelf:"flex-end"},imagem:ia,titulo:"Estudos Técnicos Aprofundados",descricao:" Otimize seus estudos técnicos preliminares com a MIA, nossa Inteligência Artificial. Ela  auxilia na geração de análises bem elaboradas, garantindo um entendimento completo da demanda  e a melhor abordagem para atendê-la. Conte com a precisão e eficiência da MIA para impulsionar  seus projetos. "}),n.createElement(oa,{style:{alignSelf:"flex-start"},imagem:la,titulo:"Formalização de Demandas Inteligente e Eficaz",descricao:" Simplifique a formalização de suas demandas com a MIA. Nossa Inteligência Artificial auxilia na  criação de objetos e justificativas claras e concisas, detalhando o que é a demanda e o motivo  de sua necessidade. Garanta documentos bem elaborados e um processo mais eficiente com a MIA. "}),n.createElement(oa,{style:{alignSelf:"flex-end"},imagem:sa,titulo:"Avaliação de Riscos Inteligente e Seguras",descricao:" Minimize riscos em suas contratações com a MIA, nossa Inteligência Artificial especializada em  avaliação de perigos. Ela analisa dados complexos e identifica potenciais vulnerabilidades,  fornecendo insights cruciais para decisões mais seguras e eficientes. Confie na MIA para  proteger seus projetos. "})))}function fa(){return n.createElement("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"50rem"}},"Notícias")}function pa(){return n.createElement("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"50rem"}},"Conteúdo")}const ga=Vt.div`
    position: relative;
    max-width: 100%;
    overflow: hidden;
    border-radius: 1rem;
...
`;function Aa(e){let{images:t}=e;const{0:r,1:a}=(0,n.useState)(0),o=(0,n.useRef)(null),i=t.length,s=Math.ceil(i/3);return(0,n.useEffect)((()=>{o.current&&(o.current.style.transition="transform 0.5s ease-in-out",o.current.style.transform=`translateX(-${100*r}%)`)}),[r]),n.createElement(ga,null,n.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"}},n.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",background:"#ffffff",height:"35rem",width:"100%",zIndex:1}},n.createElement(ya,{onClick:()=>{a((e=>Math.max(0,e-1)))}},"<")),n.createElement(ha,{ref:o},t.map(((e,t)=>n.createElement(ba,{key:t},n.createElement(va,{src:e}))))),n.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",background:"#ffffff",height:"35rem",width:"100%",zIndex:1}},n.createElement(ya,{onClick:()=>{a((e=>Math.min(s-1,e+1)))}},">"))),n.createElement(xa,null,Array.from({length:s}).map(((e,t)=>n.createElement(wa,{key:t,className:r===t?"active":"",onClick:()=>(e=>{a(e)})(t)})))))}const Ea=Vt.div`
    display: flex;
    align-items: center;
    justify-content: center;
    flex-direction: column;
...
`;function Ca(){return n.createElement(Ea,null,n.createElement(ka,null,"Depoimentos"),n.createElement(Aa,{images:[fn,pn,gn,fn,pn,gn,fn,pn,gn]}))}const Sa=()=>n.createElement("div",{title:"Home"});var ja=()=>{const[e,t]=n.useState(0),r=()=>{const e=window.scrollY;t(e)};(0,n.useEffect)((()=>(window.addEventListener("scroll",r),()=>{window.removeEventListener("scroll",r)})),[]);const a=0===e;return n.createElement(er,null,n.createElement(on,null,n.createElement(rr,{isCabecalhoFlutuante:a},n.createElement(Ht,{isCabecalhoFlutuante:a}),n.createElement(yr,null),n.createElement($t,{isCabecalhoFlutuante:a})),n.createElement(cr,null),n.createElement(nn,null)),n.createElement(Yr,null),n.createElement(kn,null),n.createElement(Un,null),n.createElement($n,null),n.createElement(da,null),n.createElement(Ca,null),n.createElement(fa,null),n.createElement(pa,null),n.createElement(wr,null,"Rodapé"))}}}]);
//# sourceMappingURL=component---src-pages-index-tsx-05dc87cab17bf8c14ba6.js.map