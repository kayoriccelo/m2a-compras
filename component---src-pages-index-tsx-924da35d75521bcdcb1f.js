...
`,Ua=Vt.label`
    ...
    color: #003366;
    color: #333;
`;function Wa(e){let{windowWidth:t,handleResize:r}=e;return n.createElement(Ga,null,n.createElement(Ua,null,"Depoimentos"),n.createElement(Ta,{windowWidth:t,handleResize:r,images:[kn,Cn,Sn,kn,Cn,Sn,kn,Cn,Sn]}))}const Va=()=>n.createElement("div",{title:"Home"});var Za=()=>{const{0:e,1:t}=(0,n.useState)(0),{0:r,1:a}=(0,n.useState)(0),{0:o,1:i}=(0,n.useState)(!1);(0,n.useEffect)((()=>{i(!0);const e=()=>{a(window.scrollY)},r=()=>{t(window.innerWidth)};return t(window.innerWidth),window.addEventListener("scroll",e),window.addEventListener("resize",r),()=>{window.removeEventListener("scroll",e),window.removeEventListener("resize",r)}}),[]);const s=0===r;return o?n.createElement(Qt,null,n.createElement(gn,{isCabecalhoFlutuante:s,windowWidth:e}),n.createElement(dr,null),n.createElement(Dn,null),n.createElement(ta,null),n.createElement(ha,null),n.createElement(Wa,{windowWidth:e}),n.createElement(Pa,null),n.createElement(Ma,null),n.createElement(Ht,null,"Rodapé")):null}}}]);
//# sourceMappingURL=component---src-pages-index-tsx-924da35d75521bcdcb1f.js.map