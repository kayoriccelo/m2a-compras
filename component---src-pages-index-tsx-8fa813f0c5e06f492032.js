...
`;function fn(){return i.createElement(pn,null,"Mais clientes")}const gn=Xe.div`
    display: flex;
    align-items: center;
    justify-content: center;
    flex-direction: column;
...
`;function Vn(){return i.createElement(Rn,null,"Selecione um plano")}const On=Xe.div`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
...
`;function Fn(t){let{children:e}=t;const{0:n,1:r}=(0,i.useState)(!1);(0,i.useEffect)((()=>{const t=()=>{window.scrollY>100&&!n?r(!0):window.scrollY<=100&&n&&r(!1)};return window.addEventListener("scroll",t),()=>{window.removeEventListener("scroll",t)}}),[n]);const o=n?"cabecalho-fixo":"cabecalho-suspenso";return i.createElement(On,{className:o},e)}const In=Xe.button`
    height: 3rem;
    width: 18rem;
    font-weight: bold;
    font-size: 1.1rem;
...
`;function Ln(){return i.createElement(In,null,"Solicite uma apresentação")}const zn=Xe.div`
    border-bottom-left-radius: 2rem;
    border-bottom-right-radius: 2rem;   
    height: 50rem;
    display: flex;
...
`;function Un(){return i.createElement(zn,null,i.createElement(Bn,null,i.createElement(Nn,null,"A M2A tem as soluções"),i.createElement(Yn,null,"que você precisa para realizar suas contratações governamentais!"),i.createElement(Ln,null)))}var qn=n(6512);const Wn=Ge`
    from {
        width: 0%;
    }
    to {
...
`;function Mi(t){let{ehCabecalhoFlutuante:e,larguraAtual:n}=t;return i.createElement(Ci,null,i.createElement(Fn,null,i.createElement(Dn,{ehCabecalhoFlutuante:e}),n<=1024?i.createElement(ai,null):i.createElement(Jn,null),i.createElement(Vn,null)),i.createElement(Un,null),i.createElement(Ti,null))}const ji=Xe.div`
...
`,$i=Xe.label`
    font-family: 'Montserrat Alternates', sans-serif;
    font-size: 1.2rem;
`;function Hi(){return i.createElement(Ui,null,i.createElement(qi,null,i.createElement(Wi,null,i.createElement(Gi,null,"Nossas soluções são completas para que a gestão governamental do seu munícipio seja realizada com excelência."),i.createElement($i,null,"Nosso portfólio completo permite centralizar todas as soluções de gestão governamental em um único local. Desde o planejamento, passando pela documento de formalização de demanda, processos administrativos e contratação, até a gestão de contratos.")),i.createElement(Xi,null,i.createElement(Oi,{titulo:"M2A Planejamentos",descricao:"Planeje suas demandas",url_imagem:Ni,style:{background:"royalblue"}}),i.createElement(Oi,{titulo:"M2A Compras",descricao:"Crie suas demandas",url_imagem:Li,style:{background:"rgba(0, 110, 156, 0.69)"}}),i.createElement(Oi,{titulo:"M2A Pesquisas",descricao:"Realize suas cotações de preço",url_imagem:zi,style:{background:"#0F9B8E"}}),i.createElement(Oi,{titulo:"M2A Processos",descricao:"Parametrize suas contratações",url_imagem:Bi,style:{background:"#478dcc"}}),i.createElement(Oi,{titulo:"M2A Fornecedores",descricao:"Participe de contratações",url_imagem:Yi,style:{background:"#2b576e"}}),i.createElement(Oi,{titulo:"M2A Contratos",descricao:"Gerencie seus contratos",url_imagem:Ni,style:{background:"#2F4F4F"}}))),i.createElement(Ii,null))}var Ki=n(6973),Zi=n(7909),Ji=n(5867),Qi=n(5066),_i=n(1351),tr=n(2388),er=n(1406);const nr=Xe.div`
...
`,qr=Xe.img`
    ...
    background: blue;
    margin: 1.5rem;
`;function Wr(t){let{numero:e,titulo:n,data:r,imagem:o,style:s}=t;return i.createElement(zr,{style:s},i.createElement(Br,null,e),i.createElement(Nr,null,i.createElement(Yr,null,n),i.createElement(Ur,null,r)),i.createElement(qr,{src:o}))}const Xr=Xe.button`
    height: 2.5rem;
    width: 12rem;
    font-weight: 600;
    font-size: 1.1rem;
...
`;function Gr(){return i.createElement(Xr,null,"Mais notícias")}const $r=Xe.div`
    display: flex;
    align-items: center;
    justify-content: center;
    flex-wrap: wrap;
...
`,eh=[{x:-0,y:-300},{x:0,y:300},{x:-300,y:200},{x:300,y:200},{x:-390,y:0},{x:390,y:0},{x:-300,y:-200},{x:300,y:-200}],nh=t=>{let{data:e,isVisible:n}=t;const r={hidden:{opacity:0,scale:.5,x:0,y:0},visible:t=>({opacity:1,scale:1,x:eh[t].x,y:eh[t].y,transition:{delay:.1*t,duration:.5,type:"spring",stiffness:100}})};return i.createElement(Qd,null,i.createElement(_d,{animate:n?{scale:[1,1.1,1],rotate:[0,10,-10,0]}:{scale:.5},transition:{duration:1,ease:"easeInOut",repeat:n?1/0:0,repeatDelay:3}},"Conteúdos"),null==e?void 0:e.map(((t,e)=>i.createElement(th,{key:`${e}-${n}`,custom:e,initial:"hidden",animate:n?"visible":"hidden",variants:r,bgImage:t.imagem,whileHover:{scale:1.1,transition:{duration:.5},zIndex:1e3}},i.createElement("div",{style:{background:"rgba(0, 110, 156, 0.69)",padding:"0.5rem 0.8rem",borderRadius:"0.5rem"}},t.titulo)))))},ih=[{id:1,titulo:"Governança Digital",imagem:Bi},{id:2,titulo:"Soluções Integradas",imagem:Li},{id:3,titulo:"Segurança de Dados",imagem:zi},{id:4,titulo:"Inovação Tecnológica",imagem:Ni},{id:5,titulo:"Atendimento ao Cidadão",imagem:Yi},{id:6,titulo:"Transformação Digital",imagem:Bi},{id:7,titulo:"Parcerias Estratégicas",imagem:Li},{id:8,titulo:"Sustentabilidade",imagem:zi}];var rh=()=>{const t=(0,i.useRef)(null),{0:e,1:n}=(0,i.useState)(!1);return(0,i.useEffect)((()=>{const e=new IntersectionObserver((t=>{t.forEach((t=>{n(t.isIntersecting)}))}),{threshold:.1});return t.current&&e.observe(t.current),()=>{t.current&&e.unobserve(t.current)}}),[]),i.createElement("div",{ref:t},i.createElement(nh,{data:ih,isVisible:e}))},oh=n(9879);const sh=Xe.div`
    position: relative;
    overflow: hidden;
    border-radius: 1rem;
...
`;function yh(t){let{windowWidth:e,registros:n}=t;const r=n.length,o=(0,i.useRef)(null),{0:s,1:a}=(0,i.useState)(0),{0:l,1:c}=(0,i.useState)(3),{0:u,1:m}=(0,i.useState)(Math.ceil(r/l));return(0,i.useEffect)((()=>{e<=768&&(c(1),m(Math.ceil(r/l)))}),[e]),(0,i.useEffect)((()=>{o.current&&(o.current.style.transition="transform 0.5s ease-in-out",o.current.style.transform=`translateX(-${100*s}%)`)}),[s]),i.createElement(sh,null,i.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"}},i.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",background:"#ffffff",height:"35rem",width:"100%",zIndex:1}},i.createElement(ph,{onClick:()=>{a((t=>Math.max(0,t-1)))}},i.createElement(oh.oe,null))),i.createElement(ah,{ref:o},n.map(((t,e)=>i.createElement(ch,{key:e},i.createElement(lh,{imagem:t.imagem}),i.createElement(uh,null,i.createElement(mh,null,t.titulo),i.createElement(dh,null,t.descricao),i.createElement(hh,null,"Assistir")))))),i.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",background:"#ffffff",height:"35rem",width:"100%",zIndex:1}},i.createElement(ph,{onClick:()=>{a((t=>Math.min(u-1,t+1)))}},i.createElement(oh.mny,null)))),i.createElement(fh,null,Array.from({length:u}).map(((t,e)=>i.createElement(gh,{key:e,className:s===e?"active":"",onClick:()=>(t=>{a(t)})(e)})))))}const vh=Xe.div`
    display: flex;
    align-items: center;
    justify-content: center;
    flex-direction: column;
...
`,bh=Xe.label`
    ...
    color: #003366;
    color: #333;
`;function xh(t){let{windowWidth:e}=t;return i.createElement(vh,null,i.createElement(bh,null,"Depoimentos"),i.createElement(yh,{windowWidth:e,registros:[{titulo:"João Silva",descricao:"A M2A transformou completamente nossos processos internos. A implementação do sistema foi suave e a equipe de suporte é excepcional. Recomendo fortemente!",imagem:Li},{titulo:"Maria Santos",descricao:"Estamos muito satisfeitos com as soluções da M2A. O sistema é intuitivo e nos ajudou a reduzir custos operacionais em 30%. Excelente parceria!",imagem:zi},{titulo:"Pedro Oliveira",descricao:"A automação que a M2A implementou revolucionou nossa gestão de compras. O atendimento é sempre ágil e profissional. Superou todas as expectativas!",imagem:Bi},{titulo:"Ana Rodrigues",descricao:"Depois que implementamos as soluções da M2A, nossa produtividade aumentou significativamente. A equipe técnica é muito competente e dedicada.",imagem:Li},{titulo:"Carlos Mendes",descricao:"Excelente experiência com a M2A! O sistema é robusto e a equipe sempre está disposta a nos ajudar. Melhor decisão que tomamos para nossa empresa.",imagem:zi},{titulo:"Fernanda Lima",descricao:"A parceria com a M2A tem sido fundamental para nosso crescimento. O suporte é impecável e as soluções são perfeitamente adaptadas às nossas necessidades.",imagem:Bi},{titulo:"Ricardo Almeida",descricao:"Impressionante como a M2A entende as necessidades do cliente. O sistema é completo e a equipe sempre traz soluções inovadoras para nossos desafios.",imagem:Li},{titulo:"Beatriz Costa",descricao:"A M2A nos ajudou a otimizar todos os processos. O retorno sobre o investimento foi rápido e o suporte técnico é sempre muito eficiente.",imagem:zi},{titulo:"Lucas Ferreira",descricao:"Desde que começamos a trabalhar com a M2A, nossa eficiência operacional melhorou drasticamente. A equipe é muito profissional e comprometida.",imagem:Bi}]}))}const wh=()=>i.createElement("div",{title:"Home"});var Eh=()=>{const{0:t,1:e}=(0,i.useState)(0),{0:n,1:r}=(0,i.useState)(0),o=()=>{const t=window.scrollY;r(t)},s=()=>{e(window.innerWidth)};(0,i.useEffect)((()=>(window.addEventListener("scroll",o),window.addEventListener("resize",s),s(),()=>{window.removeEventListener("scroll",o),window.removeEventListener("resize",s)})),[]);const a=0===n;return i.createElement(He,null,i.createElement(Mi,{ehCabecalhoFlutuante:a,larguraAtual:t}),i.createElement(kn,null),i.createElement(Hi,null),i.createElement(pr,null),i.createElement(Ar,null),i.createElement(Lr,null),i.createElement(xh,{windowWidth:t}),i.createElement(_r,null),i.createElement(rh,null),i.createElement(un,null))}}}]);
//# sourceMappingURL=component---src-pages-index-tsx-8fa813f0c5e06f492032.js.map