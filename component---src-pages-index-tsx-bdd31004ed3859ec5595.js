...
`,th=[{x:-120,y:-120},{x:120,y:-120},{x:-120,y:120},{x:120,y:120},{x:0,y:-170},{x:0,y:170},{x:-170,y:0},{x:170,y:0}],eh=t=>{let{data:e,isVisible:n}=t;const r={hidden:{opacity:0,scale:.5,x:0,y:0},visible:t=>({opacity:1,scale:1,x:th[t].x,y:th[t].y,transition:{delay:.1*t,duration:.5,type:"spring",stiffness:100}})};return i.createElement(Jm,null,i.createElement(Qm,{key:n?"visible":"hidden",initial:{scale:.5,opacity:0},animate:n?{scale:1,opacity:1}:{scale:.5,opacity:0},transition:{duration:.5}},"Conteúdos"),null==e?void 0:e.map(((t,e)=>i.createElement(_m,{key:`${e}-${n}`,custom:e,initial:"hidden",animate:n?"visible":"hidden",variants:r,bgImage:t.imagem,whileHover:{scale:1.1,boxShadow:"0 8px 30px rgba(255, 255, 255, 0.2)",transition:{duration:.5},zIndex:1e3}},t.titulo))))},nh=[{id:1,titulo:"Governança Digital",imagem:Bi},{id:2,titulo:"Soluções Integradas",imagem:Li},{id:3,titulo:"Segurança de Dados",imagem:zi},{id:4,titulo:"Inovação Tecnológica",imagem:Ni},{id:5,titulo:"Atendimento ao Cidadão",imagem:Yi},{id:6,titulo:"Transformação Digital",imagem:Bi},{id:7,titulo:"Parcerias Estratégicas",imagem:Li},{id:8,titulo:"Sustentabilidade",imagem:zi}];var ih=()=>{const t=(0,i.useRef)(null),{0:e,1:n}=(0,i.useState)(!1);return(0,i.useEffect)((()=>{const e=new IntersectionObserver((t=>{t.forEach((t=>{n(t.isIntersecting)}))}),{threshold:.1});return t.current&&e.observe(t.current),()=>{t.current&&e.unobserve(t.current)}}),[]),i.createElement("div",{ref:t},i.createElement(eh,{data:nh,isVisible:e}))},rh=n(9879);const oh=qe.div`
    position: relative;
    overflow: hidden;
    border-radius: 1rem;
