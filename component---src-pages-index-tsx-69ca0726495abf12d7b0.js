...
`;function xr(e){let{isCabecalhoFlutuante:t}=e;return n.createElement(yr,{isCabecalhoFlutuante:t},"Selecione um plano")}const vr=Vt.div`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
...
`;var rn=()=>n.createElement(Hr,null,n.createElement(Kr,null,n.createElement($r,{src:Wr,alt:"M2A Compras"})),n.createElement(Kr,null,n.createElement(_r,{src:Zr,alt:"M2A Planejamento"})),n.createElement(Kr,null,n.createElement(en,{src:Qr,alt:"M2A Fornecedores"})),n.createElement(Kr,null,n.createElement(tn,{src:Jr,alt:"M2A Pesquisas"})));function nn(){return n.createElement(qr,null,n.createElement(Lr,null,n.createElement(Br,null,"M2A")," é o mais ",n.createElement(Vr,{palavras:["eficiente","completo","prático"],tempoRotacao:3e3})," portal de contratações públicas."),n.createElement(Tr,null,"Todas as ferramentas em um só lugar, para quem vai vender e quem vai comprar."),n.createElement(rn,null))}const an=Vt.div`
    ...
    margin-bottom: 4px;
    overflow: hidden;
`;function on(e){let{isCabecalhoFlutuante:t}=e;return n.createElement(an,null,n.createElement(wr,null,n.createElement(br,{isCabecalhoFlutuante:t}),n.createElement(Yr,null),n.createElement(xr,{isCabecalhoFlutuante:t})),n.createElement(zr,null),n.createElement(nn,null))}const sn=Vt.div`
...
`,xa=Vt.img`
    ...
    background: blue;
`;function va(e){let{numero:t,titulo:r,data:a,imagem:o,style:i}=e;return n.createElement(pa,{style:i},n.createElement(ga,null,t),n.createElement(ha,null,n.createElement(ba,null,r),n.createElement(ya,null,a)),n.createElement(xa,{src:o}))}const wa=Vt.button`
    height: 2.5rem;
    width: 12rem;
    font-weight: 600;
    font-size: 1.1rem;
...
`;function Aa(){return n.createElement(wa,null,"Mais notícias")}const Ea=Vt.div`
    display: flex;
    align-items: center;
    justify-content: center;
    flex-wrap: wrap;
...
`,ja=Vt.label`
    ...
    height: 10rem;
    width: 100%;
`;function za(){return n.createElement(Ea,null,n.createElement(ja,null,"Nóticias"),n.createElement(ka,null,n.createElement(Ca,{src:hn})),n.createElement(Sa,null,n.createElement(va,{numero:"4°",titulo:"Quarta Nóticia",data:"12 de maio",imagem:pn}),n.createElement(va,{numero:"5°",titulo:"Quinta Nóticia",data:"11 de maio",imagem:pn}),n.createElement(va,{numero:"6°",titulo:"Sexta Nóticia",data:"10 de maio",imagem:pn}),n.createElement(va,{numero:"7°",titulo:"Sétima Nóticia",data:"10 de maio",imagem:pn})),n.createElement(Aa,null))}function Ia(){return n.createElement("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"50rem"}},"Conteúdo")}var Pa=r(9879);const Oa=Vt.div`
    position: relative;
    overflow: hidden;
    border-radius: 1rem;
`,Ma=Vt.div`
...
`;function qa(e){let{images:t}=e;const{0:r,1:a}=(0,n.useState)(0),o=(0,n.useRef)(null),i=t.length,s=Math.ceil(i/3);return(0,n.useEffect)((()=>{o.current&&(o.current.style.transition="transform 0.5s ease-in-out",o.current.style.transform=`translateX(-${100*r}%)`)}),[r]),n.createElement(Oa,null,n.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"}},n.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",background:"#ffffff",height:"35rem",width:"100%",zIndex:1}},n.createElement(Da,{onClick:()=>{a((e=>Math.max(0,e-1)))}},n.createElement(Pa.oe,null))),n.createElement(Ma,{ref:o},t.map(((e,t)=>n.createElement(Ra,{key:t},n.createElement(Fa,{src:e}))))),n.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",background:"#ffffff",height:"35rem",width:"100%",zIndex:1}},n.createElement(Da,{onClick:()=>{a((e=>Math.min(s-1,e+1)))}},n.createElement(Pa.mny,null)))),n.createElement(Na,null,Array.from({length:s}).map(((e,t)=>n.createElement(Ya,{key:t,className:r===t?"active":"",onClick:()=>(e=>{a(e)})(t)})))))}const La=Vt.div`
    display: flex;
    align-items: center;
    justify-content: center;
    flex-direction: column;
